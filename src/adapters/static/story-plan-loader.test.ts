...
const validPlanYaml = [
  ...
  "    status: developing",
  "    importance: major",
  "    introduced_at_checkpoint: 100",
  "    last_touched_at_checkpoint: 200",
  ...
  "    seeded_at_checkpoint: 300",
  "    last_touched_at_checkpoint: 400",
  "    payoff_at_checkpoint: 500",
  "    prerequisites:",
  ...
  it("fully parses a valid plan with snake_case -> camelCase mapping", async () => {
    ...
    try {
      ...
      expect(terminalOrigin).toMatchObject({
        ...
        status: "developing",
        importance: "major",
        introducedAtCheckpoint: 100,
        lastTouchedAtCheckpoint: 200,
      ...
      expect(terminalReacts).toMatchObject({
        ...
        seededAtCheckpoint: 300,
        lastTouchedAtCheckpoint: 400,
        payoffAtCheckpoint: 500,
