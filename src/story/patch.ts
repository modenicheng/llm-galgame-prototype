/**
 * Patch merging and validation for StoryState.
 *
 * `mergePatches` merges two partial patches. `validatePatch` checks
 * an unknown value against the `StoryStatePatchSchema`.
 */

import { StoryStatePatchSchema } from "./types.js";
import type { StoryStatePatch, StoryThread } from "./types.js";
