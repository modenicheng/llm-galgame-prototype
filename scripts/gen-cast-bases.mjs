...
// 比例锚定：树莓娘实测约 5.5 头身（头大萌系）。头身比按人设/年龄微调——
// 女生与参考图一致（5.5），年下男生 5.5~6，年长学长 6（头略小于女生但仍属
// 萌系，严禁 7 头身以上的写实比例，也严禁细长身材）。比例句按角色注入。
...
const CAST = [
  {
    id: "female_A",
    ratio:
      "头大而圆润的萌系比例，与参考图完全一致（约5.5头身，头顶到下巴约占全身五分之一），肩窄、手脚小巧；严禁头小身长的写实比例。",
  ...
  },
  {
    id: "male_A",
    ratio:
      "头大而圆润的萌系比例，与参考图基本一致（约5.5~6头身，头顶到下巴约占全身的五分之一到六分之一），男生肩部自然放宽、体格匀称；严禁头小身长的写实比例。",
  ...
  },
  {
    id: "male_B",
    ratio:
      "略成熟但仍偏萌系的比例：约6头身（头顶到下巴约占全身六分之一），头部比女生角色略小但仍然明显偏大；肩宽适中（约两个头宽）、体格匀称、四肢粗细正常、腿长正常，身材绝不细长；严禁7头身以上的写实比例。",
      ...
      try {
        await processOne({
          ...
          prompt: BASE_PROMPT.replace("{DESC}", character.desc)
            .replace("{POSE}", character.pose)
            .replace("{RATIO}", character.ratio),
